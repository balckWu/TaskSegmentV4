...
class TaskEncoder2D(nn.Module):
    """
    Builds task tokens from support image features, support masks, and optional text tokens.

    Uses support-mask-guided visual cross-attention and appends projected text tokens
    for the decoder and dense guidance branch.
    """
